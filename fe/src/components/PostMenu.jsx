import { Menu, MenuButton, MenuList, MenuItem, MenuDivider, IconButton, Flex, Text, useToast, Button, useDisclosure, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, Box, Image, Avatar, Input, Center } from "@chakra-ui/react";
        ...
        <>
            <Menu closeOnSelect={true}>
                ...
                <MenuList minWidth='240px' borderRadius='lg' bg={"gray.dark"}>
                    <MenuItem onClick={OpenEditMenu} bg={"gray.dark"} _active={{ bg: "gray.dark" }}>
                    ...
                    <MenuDivider />
                    <MenuItem onClick={handleDeleteClick} bg={"gray.dark"} _active={{ bg: "gray.dark" }}>
                        <Flex justifyContent="space-between" alignItems="center" w="100%">
                            <Text color="red.500" fontWeight="bold">Delete</Text>
                ...
                <ModalContent bg={"gray.dark"}>
                    <ModalHeader>
                        <Flex justifyContent={"space-between"} w={"full"}>
                            <Flex w={"full"} alignItems={"center"}>
                                ...
                                <Text fontSize={"sm"} fontWeight={"bold"} ml={2}>{user.username}</Text>
                    ...
                    <ModalBody>
                        ...
                        <Box borderRadius={"6"} overflow={"hidden"} border={"1px solid"} borderColor={"gray.light"}>
                            ...
                            />
                            <Image src={imgUrl || post.img} w={"full"} onClick={() => imageRef.current.click()} />
                        </Box>
                    </ModalBody>
                    <ModalFooter>
                        <Button
